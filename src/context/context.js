...
export const InfoForBuyers = createContext([
   {
      title: "Как заказать",
      text: "1: Зарегистрируйтесь на сайте как юридическое лицо или ИП. 2: Авторизуйтесь , добавьте в корзину понравившиеся товары и оформите заказ 3: Дождитесь звонка менеджера для подтверждения заказа 4: Скачайте счет для оплаты в личном кабинете , оплатите его и ожидайте доставку!"
   },

   {
      title: "Гарантия",
      text: "Началом гарантийного обслуживания считается момент передачи товара покупателю. Если вы хотите обратиться с гарантийным случаем, необходимо представить документ, подтверждающий покупку продукции нашего магазина. Кроме того, товар должен иметь полную комплектацию. Важно отметить, что физические повреждения мебели (порванная обивка, поцарапанные фасады и т. п.) полученные в ходе эксплуатации изделия не являются гарантийным случаем.Свои претензии вы можете направлять на электронный почтовый адрес отдела гарантии нашего магазина: bikert@mail. К сообщению необходимо приложить номер заказа, товарный чек, описание брака с вложенной фотографией поврежденной детали, а также фото фабричной этикетки с упаковки изделия и/или комплектовочную ведомость, схему сборки, с отмеченными на ней поврежденными деталями. Наши менеджеры обработают поступившую заявку в течение пяти рабочих дней, после чего с вами свяжутся для обсуждения и решения проблемы. "
   },

   {
      title: "Инструкция по эксплуатации",
      text: "Благодарим Вас за покупку и очень надеемся, что долгое время она будет приносить Вам только удовольствие. Но, чтобы в процессе эксплуатации не возникли проблемы, убедительно просим Вас ознакомиться с этой инструкцией для потребителей и придерживаться данных рекомендаций."
   },

   {
      title: "Оптовикам",
      text: "Обустройство жилья, офисов, различных учреждений – трудная и интересная задача, требующая терпения, внимания, вкуса. Все чаще прибегают сейчас к покупке мебели оптом. Это объясняется существенной экономией денежных средств и драгоценного времени. Наша мебельная компания на протяжении многих лет успешно сотрудничает с покупателями крупных партий своей продукции. "
   },

   {
      title: "Вакансии",
      text: "На распил : 1 человек, На кромочный станок: 1 человек "
   }
])
