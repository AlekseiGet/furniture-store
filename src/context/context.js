...
export const FurnityreItem = createContext([
   ...
   {
      title: "bedside",
      image: "https://mebsalon.ru/pictures/product/middle/125270_middle.jpg",
      text: "В самом названии этой спальни видится что-то мягкое, удобное и уютное. Интересное и функциональное дизайнерское решение – кровать с надстройкой – служит дополнительным местом для хранения вещей.",
      id: "bs1",
      price: "7 000 руб.",
      detail: {
         str1: "ШхВхГ: 420 х 420 х 400 ",
   ...
   {
      title: "bedside",
      image: "https://domrotang.ru/image/catalog/i/ki/hp/62d1be1a797945c2278af028ad80d1d9.jpg",
      text: "В самом названии этой спальни видится что-то мягкое, удобное и уютное. Интересное и функциональное дизайнерское решение – кровать с надстройкой – служит дополнительным местом для хранения вещей.",
      id: "bs2",
      price: "7 000 руб.",
      detail: {
   ...
   {
      title: "bedside",
      image: "https://anapa.bestmebelshop.ru/upload/iblock/38f/38f1d5d87c26a080443876cd8214ba0a.jpg",
      text: "В самом названии этой спальни видится что-то мягкое, удобное и уютное. Интересное и функциональное дизайнерское решение – кровать с надстройкой – служит дополнительным местом для хранения вещей.",
      id: "bs3",
      price: "7 000 руб.",
      detail: {
   ...
   {
      title: "child",
      image: "https://www.dommebeli.spb.ru/upload/iblock/efd/efd9fe674cf761e37bbe38ddb2761e45.jpg",
      text: "Примерно треть своей жизни человек спит. В это время наш организм восстанавливается и набирается сил. Вот почему крепкий и здоровый сон – залог бодрости и хорошего самочувствия в течение всего дня как у взрослых, так и у детей. Заботливые родители, выбирая кровать для своего ребенка, стараются остановиться на наиболее безопасном, комфортном и практичном вариант. ",
      id: "cld1",
      price: "6 000 руб.",
      detail: {
         str1: "ШхВхГ: 420 х 420 х 400 ",
   ...
   {
      title: "child",
      image: "https://www.dommebeli.spb.ru/upload/iblock/fd6/fd645a16d38bf56b493c7b28230fd467.jpg",
      text: "Примерно треть своей жизни человек спит. В это время наш организм восстанавливается и набирается сил. Вот почему крепкий и здоровый сон – залог бодрости и хорошего самочувствия в течение всего дня как у взрослых, так и у детей. Заботливые родители, выбирая кровать для своего ребенка, стараются остановиться на наиболее безопасном, комфортном и практичном вариант. ",
      id: "cld2",
      price: "6 000 руб.",
      detail: {
   ...
   {
      title: "child",
      image: "https://krovati-yaroff.ru/upload/shop_1/1/6/7/item_16717/item_16717.jpg",
      text: "Примерно треть своей жизни человек спит. В это время наш организм восстанавливается и набирается сил. Вот почему крепкий и здоровый сон – залог бодрости и хорошего самочувствия в течение всего дня как у взрослых, так и у детей. Заботливые родители, выбирая кровать для своего ребенка, стараются остановиться на наиболее безопасном, комфортном и практичном вариант. ",
      id: "cld3",
      price: "6 000 руб.",
      detail: {
   ...
   {
      title: "child",
      image: "https://100meb.ru/upload/iblock/b97/b977d69fa3589bb79a4373ef8de7cb94.jpg",
      text: "Примерно треть своей жизни человек спит. В это время наш организм восстанавливается и набирается сил. Вот почему крепкий и здоровый сон – залог бодрости и хорошего самочувствия в течение всего дня как у взрослых, так и у детей. Заботливые родители, выбирая кровать для своего ребенка, стараются остановиться на наиболее безопасном, комфортном и практичном вариант. ",
      id: "cld4",
      price: "6 000 руб.",
      detail: {
    ...
    {
       title: "closet",
       image: "https://garnitur77.ru/upload/iblock/7d9/7d972e2354f743626b50d33541a30dac.jpg",
       text: "Шкаф Комфорт 16 выглядит стильно и современно, помимо этого его качественные материалы и сборка позволят пользоваться им на протяжении долгих лет. А спокойные и легкие сочетания цветов создадут приятную атмосферу в вашей комнате и будут отлично смотреться в любом интерьере.",
      id: "clt1",
      price: "6 000 руб.",
      detail: {
         str1: "ШхВхГ: 420 х 420 х 400 ",
   ...
   {
      title: "closet",
      image: "https://tsvetmebel.ru/image/cache/catalog/00_KORPUS/RASPASHN/GLYANEC/glamur_15-1200x800.jpg",
      text: "Шкаф Комфорт 16 выглядит стильно и современно, помимо этого его качественные материалы и сборка позволят пользоваться им на протяжении долгих лет. А спокойные и легкие сочетания цветов создадут приятную атмосферу в вашей комнате и будут отлично смотреться в любом интерьере.",
      id: "clt2",
      price: "6 000 руб.",
      detail: {
   ...
   {
      title: "closet",
      image: "https://www.mebelbspb.ru/images/tovar/cover2822.jpg",
      text: "Шкаф Комфорт 16 выглядит стильно и современно, помимо этого его качественные материалы и сборка позволят пользоваться им на протяжении долгих лет. А спокойные и легкие сочетания цветов создадут приятную атмосферу в вашей комнате и будут отлично смотреться в любом интерьере.",
      id: "clt3",
      price: "6 000 руб.",
      detail: {
